...
if ( ! class_exists( 'Sinatra_Customizer_Widget_Finanzas' ) ) :

	/**
	 * Sinatra Customizer widget class
	 */
	class Sinatra_Customizer_Widget_Finanzas extends Sinatra_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$args['name']        = __( 'Finanzas', 'sinatra' );
			$args['description'] = __( 'Subscribe and Socials.', 'sinatra' );
