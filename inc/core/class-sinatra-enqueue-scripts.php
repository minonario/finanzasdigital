...
function sinatra_enqueues() {
	...
	do_action( 'sinatra_enqueue_scripts' );
        ...
        wp_enqueue_script('custom-fd-js', get_template_directory_uri() . '/assets/js/custom-fd.js', array('jquery'), null, true );
        //wp_enqueue_script('lazy-js', get_template_directory_uri() . '/assets/js/lazy.js', array('ustom-fd-js'), null, true );
        
        wp_enqueue_style('custom-css', get_template_directory_uri() . '/assets/css/custom-fd.css', array('sinatra-styles'), '3');
