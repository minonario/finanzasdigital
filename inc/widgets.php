...
if ( ! function_exists( 'sinatra_widgets_init' ) ) :
	...
	function sinatra_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Home Sidebar', 'sinatra' ),
				'id'            => 'fd-sidebar',
				'description'   => esc_html__( 'Widgets in this area are displayed in the top sidebar area based on your Default Sidebar Position settings.', 'sinatra' ),
				'before_widget' => '<div id="%1$s" class="si-fd-sidebar-widget si-widget si-entry widget %2$s">',
				'after_widget'  => '</div>',
